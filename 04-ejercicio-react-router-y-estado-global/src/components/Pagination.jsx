...
export function Pagination({ currentPage = 1, totalPages = 10, onPageChange }) {
  ...
  return (
    <nav className={styles.pagination} aria-label="Pagination">
      <a aria-label="previous" href={buildPageUrl(currentPage - 1)} style={stylePrevButton} onClick={handlePrevClick}>
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
      ...
      <a href={buildPageUrl(currentPage + 1)} style={styleNextButton} onClick={handleNextClick} aria-label='next'>
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
